...
describe("MetaMaskController", function() {
  ...
  describe("#getGasPrice", function() {
    it("gives the 50th percentile lowest accepted gas price from recentBlocksController", async function() {
      ...
      assert.equal(
        gasPrice,
        "0x3b9aca00",
        "accurately estimates 50th percentile accepted gas price"
      );
  ...
  describe("connectHardware", function() {
    it("should throw if it receives an unknown device name", async function() {
      try {
        ...
        assert.equal(
          e,
          "Error: MetamaskController:connectHardware - Unknown device"
        );
      }
    });
  ...
  describe("checkHardwareStatus", function() {
    it("should throw if it receives an unknown device name", async function() {
      try {
        ...
        assert.equal(
          e,
          "Error: MetamaskController:checkHardwareStatus - Unknown device"
        );
      }
    });
  ...
  describe("forgetDevice", function() {
    it("should throw if it receives an unknown device name", async function() {
      try {
        ...
        assert.equal(
          e,
          "Error: MetamaskController:forgetDevice - Unknown device"
        );
      }
    });
  ...
  describe("unlockTrezorAccount", function() {
    ...
    beforeEach(async function() {
      ...
      await metamaskController.connectHardware("trezor", 0).catch(e => null);
      await metamaskController
        .unlockTrezorAccount(accountToUnlock)
        .catch(e => null);
    });
  ...
  describe("#setCurrentCurrency", function() {
    ...
    it("sets currency to JPY", function() {
      ...
      assert.equal(
        metamaskController.currencyController.getCurrentCurrency(),
        "JPY"
      );
    });
  });
  ...
  describe("#createShapeshifttx", function() {
    ...
    beforeEach(function() {
      ...
      depositType = "ETH";
      shapeShiftTxList = metamaskController.shapeshiftController.store.getState()
        .shapeShiftTxList;
    });
