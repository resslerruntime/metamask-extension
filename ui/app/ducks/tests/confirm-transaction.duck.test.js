...
const FETCH_METHOD_DATA_START =
  "metamask/confirm-transaction/FETCH_METHOD_DATA_START";
const FETCH_METHOD_DATA_END =
  "metamask/confirm-transaction/FETCH_METHOD_DATA_END";
...
describe("Confirm Transaction Duck", () => {
    ...
    it("should set fetchingMethodData to false when receiving a FETCH_METHOD_DATA_END action", () => {
      assert.deepEqual(
        ConfirmTransactionReducer(
          { confirmTransaction: { fetchingMethodData: true } },
          {
  ...
  describe("Single actions", () => {
    ...
    it("should create an action to set fetchingMethodData to true", () => {
      ...
      assert.deepEqual(actions.setFetchingMethodData(true), expectedAction);
    });
    ...
    it("should create an action to set fetchingMethodData to false", () => {
      ...
      assert.deepEqual(actions.setFetchingMethodData(false), expectedAction);
    });
