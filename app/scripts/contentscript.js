...
function setupStreams() {
  ...
  pump(pageStream, pluginStream, pageStream, err =>
    logStreamDisconnectWarning("MetaMask Contentscript Forwarding", err)
  );
  ...
  pump(mux, pageStream, mux, err =>
    logStreamDisconnectWarning("MetaMask Inpage", err)
  );
  pump(mux, pluginStream, mux, err =>
    logStreamDisconnectWarning("MetaMask Background", err)
  );

  // connect ping stream
  const pongStream = new PongStream({ objectMode: true });
  pump(mux, pongStream, mux, err =>
    logStreamDisconnectWarning("MetaMask PingPongStream", err)
  );
