...
TxList.prototype.render = function() {
  return h("div.flex-column", [
    ...
    h("div.flex-column.tx-list-container", {}, [this.renderTransaction()])
  ]);
};
...
TxList.prototype.renderTransaction = function() {
  ...
  return txsToRender.length
    ? txsToRender.map((transaction, i) =>
        this.renderTransactionListItem(transaction, conversionRate, i)
      )
    : [
        h("div.tx-list-item.tx-list-item--empty", { key: "tx-list-none" }, [
