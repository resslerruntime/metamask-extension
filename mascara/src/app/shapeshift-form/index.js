  ...
  renderMetadata(label, value) {
    return (
      <div className="shapeshift-form__metadata-wrapper">
        <div className="shapeshift-form__metadata-label">{label}:</div>
        <div className="shapeshift-form__metadata-value">{value}</div>
      </div>
    );
  }
        ...
        <div className="shapeshift-form">
          <div className="shapeshift-form__selectors">
            <div className="shapeshift-form__selector">
              <div className="shapeshift-form__selector-label">Deposit</div>
              <select
            ...
            />
            <div className="shapeshift-form__selector">
              <div className="shapeshift-form__selector-label">Receive</div>
              <div className="shapeshift-form__selector-input">ETH</div>
            </div>
          </div>
          <div
