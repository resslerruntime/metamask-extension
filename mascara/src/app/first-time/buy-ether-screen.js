    ...
    return (
      <div className="buy-ether__action-content-wrapper">
        ...
        <div className="buy-ether__body-text">
          Coinbase is the world’s most popular way to buy and sell bitcoin,
          ethereum, and litecoin.
        </div>
        <a className="first-time-flow__link buy-ether__faq-link">
          What is Ethereum?
        </a>
      ...
      case OPTION_VALUES.SHAPESHIFT:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <div className="buy-ether__body-text">
              Trade any leading blockchain asset for any other. Protection by
      ...
      case OPTION_VALUES.QR_CODE:
        return (
          <div className="buy-ether__action-content-wrapper">
            ...
            <div className="buy-ether__small-body-text">
              (This is the account address that MetaMask created for you to
              recieve funds.)
            </div>
            <div className="buy-ether__buttons">
              <button
  ...
  render() {
    ...
    return (
      <div className="buy-ether">
        ...
        <div className="buy-ether__body-text">
          MetaMask works best if you have Ether in your account to pay for
...
export default connect(
  ...
  dispatch => ({
    goToCoinbase: address =>
      dispatch(buyEth({ network: "1", address, amount: 0 })),
