...
describe("BalanceComponent", function() {
  ...
  it("shows token balance and convert to fiat value based on conversion rate", function() {
    ...
    const tokenBalance = balanceComponent
      .instance()
      .getTokenBalance(formattedBalance, false);
    const fiatDisplayNumber = balanceComponent
      .instance()
      .getFiatDisplayNumber(formattedBalance, 2);
  ...
  it("shows only the token balance when conversion rate is not available", function() {
    ...
    const fiatDisplayNumber = balanceComponent
      .instance()
      .getFiatDisplayNumber(formattedBalance, 0);
