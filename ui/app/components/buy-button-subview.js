    ...
    [
      ...
      h(
        ...
        [
          ...
          h(
            "h2.text-transform-uppercase.flex-center",
            {
              style: {
                width: "100vw",
      ...
      h(
        ...
        [
          h(
            "h3.text-transform-uppercase.flex-center",
            {
              style: {
                paddingLeft: "15px",
                width: "100vw",
...
BuyButtonSubview.prototype.primarySubview = function() {
  ...
  switch (network) {
    ...
    default:
      return h("h2.error", this.context.t("unknownNetworkId"));
  }
};
      ...
      h(
        ...
        [
          h(RadioList, {
            ...
            subtext: {
              Coinbase: `${this.context.t("crypto")}/${this.context.t(
                "fiat"
              )} (${this.context.t("usaOnly")})`,
