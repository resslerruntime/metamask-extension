...
class ConnectScreen extends Component {
  ...
  renderTrezorAffiliateLink() {
    return h("div.hw-connect__get-trezor", {}, [
      h(
        "p.hw-connect__get-trezor__msg",
        {},
        this.context.t(`dontHaveATrezorWallet`)
      ),
      h(
        "a.hw-connect__get-trezor__link",
        {
  ...
  renderTutorialSteps() {
    ...
    return h(
      ...
      steps.map((step, i) =>
        h("div.hw-connect", {}, [
          h(
            "h3.hw-connect__title",
            {},
            this.context.t(`step${i + 1}HardwareWallet`)
          ),
          h(
            "p.hw-connect__msg",
            {},
            this.context.t(`step${i + 1}HardwareWalletMsg`)
          ),
