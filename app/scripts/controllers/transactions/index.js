...
*/
  ...
  */
  _setupListners() {
    ...
    this.blockTracker.on(
      "block",
      this.pendingTxTracker.checkForTxInBlock.bind(this.pendingTxTracker)
    );
    // this is a little messy but until ethstore has been either
    // removed or redone this is to guard against the race condition
    this.blockTracker.on(
      "latest",
      this.pendingTxTracker.resubmitPendingTxs.bind(this.pendingTxTracker)
    );
    this.blockTracker.on(
      "sync",
      this.pendingTxTracker.queryPendingTxs.bind(this.pendingTxTracker)
    );
  }
