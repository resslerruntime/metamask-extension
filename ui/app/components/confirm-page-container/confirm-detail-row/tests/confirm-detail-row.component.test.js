...
describe("Confirm Detail Row Component", function() {
  ...
  describe("render", () => {
    ...
    it("should render the fiatText as a child of the confirm-detail-row__fiat", () => {
      assert.equal(
        wrapper
          .find(".confirm-detail-row__details > .confirm-detail-row__fiat")
          .childAt(0)
          .text(),
        "mockFiatText"
      );
    ...
    it("should render the ethText as a child of the confirm-detail-row__eth", () => {
      assert.equal(
        wrapper
          .find(".confirm-detail-row__details > .confirm-detail-row__eth")
          .childAt(0)
          .text(),
        "mockEthText"
      );
    ...
    it("should set the fiatTextColor on confirm-detail-row__fiat", () => {
      assert.equal(
        wrapper.find(".confirm-detail-row__fiat").props().style.color,
        "mockColor"
      );
    });
    ...
    it("should call onHeaderClick when headerText div gets clicked", () => {
      wrapper
        .find(".confirm-detail-row__header-text")
        .props()
        .onClick();
