...
class ImportAccountScreen extends Component {
  ...
  onClick = () => {
    ...
    switch (this.state.selectedOption) {
      case OPTIONS.JSON_FILE:
        return (
          importNewAccount("JSON File", [jsonFile, password])
  ...
  renderPrivateKey() {
    return Input({
      ...
      errorMessage:
        this.props.warning &&
        "Something went wrong. Please make sure your private key is correct."
    });
  }
      ...
      <div className="">
        <div className="import-account__input-wrapper">
          ...
          <div className="import-account__input-error-message">
            {warning &&
              "Something went wrong. Please make sure your JSON file is properly formatted."}
          </div>
        </div>
        {Input({
  ...
  render() {
    ...
    return this.props.isLoading ? (
      ...
      <div className="import-account">
        ...
        <div className="import-account__title">Import an Account</div>
...
export default connect(
  ...
  dispatch => ({
    importNewAccount: (strategy, args) =>
      dispatch(importNewAccount(strategy, args)),
